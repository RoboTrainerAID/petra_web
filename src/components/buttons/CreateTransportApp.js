...
export default function CreateTransportApp() {
    const {t} = useTranslation();
    const classes = useStyles();

    return (
        <Link to="/home-employee/newtransport">
            <div className="app">
                <Button className="app-button app-mobile" variant="primary">
                    <p><FaRegCalendarPlus className={classes.appIcon}/></p>
                </Button>
                <br/>
                <p className="app-text">{t('home_employee_app_createtransport')}</p>
            </div>
        </Link>
    );
}
